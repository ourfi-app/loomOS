...
export function LoomOSActionButton({
  ...
  const variantClasses = {
    ...
    danger: 'bg-gradient-to-b from-red-400 to-red-500 border border-[var(--semantic-error)] text-white hover:from-red-500 hover:to-red-600 active:from-red-600 active:to-red-700'
  };
