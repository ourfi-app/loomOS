...
export function WebOSActionButton({
  ...
  const variantClasses = {
    default: 'bg-gradient-to-b from-gray-200 to-gray-300 border border-gray-400 text-gray-700 hover:from-gray-300 hover:to-gray-400 active:from-gray-400 active:to-gray-500',
