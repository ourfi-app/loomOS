...
function ComponentCategory({ name, components }: ComponentCategoryProps) {
  ...
  return (
    <div className="mb-6">
      <h3 className="text-xs font-semibold text-[var(--semantic-text-tertiary)] dark:text-[var(--semantic-text-tertiary)] uppercase tracking-wider px-4 mb-3">
        {name}
      </h3>
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-gray-800">
      ...
      <div className="p-4 border-b border-[var(--semantic-border-light)] dark:border-gray-700">
        ...
        {searchQuery && (
          <div className="mt-2 text-xs text-[var(--semantic-text-tertiary)] dark:text-[var(--semantic-text-tertiary)]">
      ...
      <div className="flex-1 overflow-y-auto py-4">
        {Object.keys(componentsByCategory).length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-[var(--semantic-text-tertiary)] dark:text-[var(--semantic-text-tertiary)]">
