/**
 * loomOS Select Component
 * 
 * Dropdown select component with Phase 1C design token integration.
 * Uses Radix UI Select primitive with custom styling.
 * 
 * Features:
 * - Dropdown menu with items
 * - Scroll buttons for long lists
 * - Item indicators (checkmarks)
...
>(({ className, children, style, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-10 w-full items-center justify-between rounded-md px-3 py-2 text-sm ring-offset-2 placeholder:opacity-50 focus:outline-none focus:ring-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1',
      className
    )}
    style={{
