...
export const APP_REGISTRY: Record<string, AppDefinition> = {
  ...
  appDesigner: {
    ...
    canPinToDock: true,
    hasWidget: false,
    longDescription: 'Visual app designer for creating custom WebOS-style applications. Choose from pre-built templates (Email, Calendar, Tasks, Memos, Contacts) or start from scratch. Configure layouts, colors, pane styles, and design patterns. Export production-ready React components with full TypeScript support.',
    ...
    features: [
      ...
      'WebOS design system integration'
    ],
  ...
  emailApp: {
    ...
    gradient: APP_COLORS.messages.light,
    category: 'productivity',
    description: 'WebOS-style email client',
    keywords: ['email', 'mail', 'messages', 'communication', 'inbox'],
    canPinToDock: true,
    hasWidget: false,
    longDescription: 'Full-featured email client with WebOS design. Three-pane layout with account folders, message list, and detail view. Includes search, multiple account support, and attachment handling.',
  ...
  calendarApp: {
    ...
    category: 'productivity',
    description: 'WebOS-style calendar and events',
    keywords: ['calendar', 'events', 'schedule', 'meetings', 'appointments'],
    canPinToDock: true,
    hasWidget: true,
    widgetSize: 'medium',
    longDescription: 'Comprehensive calendar application with WebOS design. Features mini calendar navigation, timeline view, and detailed event display. Manage meetings, appointments, and reminders.',
  ...
  tasksApp: {
    ...
    category: 'productivity',
    description: 'WebOS-style task management',
    keywords: ['tasks', 'todos', 'checklist', 'reminders', 'productivity'],
    canPinToDock: true,
    hasWidget: true,
    widgetSize: 'medium',
    longDescription: 'Comprehensive task management with WebOS design. Create, organize, and track tasks with priority levels, due dates, and project grouping. Features include task lists, calendar integration, and progress tracking.',
  ...
  notesApp: {
    ...
    category: 'productivity',
    description: 'WebOS-style note taking',
    keywords: ['notes', 'memos', 'writing', 'documents', 'text'],
    canPinToDock: true,
    hasWidget: true,
    widgetSize: 'small',
    longDescription: 'Simple yet powerful note-taking application with WebOS design. Create, edit, and organize notes with rich text formatting. Features include folders, tags, search, and quick access to recent notes.',
