...
export const APP_REGISTRY: Record<string, AppDefinition> = {
  ...
  // Default Bundle Apps - Pre-installed essentials
  browser: {
    id: 'browser',
    title: 'Browser',
    icon: APP_ICONS.home,
    ...
    gradient: 'from-blue-500 to-cyan-500',
    category: 'essentials',
    description: 'Browse your dashboard and apps',
    keywords: ['browser', 'home', 'dashboard', 'navigate', 'explore'],
    canPinToDock: true,
    hasWidget: false,
    longDescription: 'Your central navigation hub for browsing all community features and applications. Access your dashboard, explore apps, and navigate through the platform with ease.',
    tags: ['navigation', 'dashboard', 'browse', 'essential'],
    version: '1.0.0',
    developer: 'Montrecott Team',
    ...
    permissions: ['View dashboard', 'Access apps'],
    feedbackEnabled: true,
    isNew: true,
    averageRating: 5.0,
    totalRatings: 1,
  ...
  mail: {
    ...
    keywords: ['mail', 'email', 'messages', 'communication', 'inbox'],
    canPinToDock: true,
    hasWidget: true,
    widgetSize: 'medium',
    longDescription: 'Full-featured email client for managing your community communications. Send and receive emails, organize your inbox, and stay connected with residents and board members.',
    tags: ['email', 'communication', 'inbox', 'essential'],
    version: '1.0.0',
    developer: 'Montrecott Team',
    releaseDate: '2025-11-25',
    lastUpdated: '2025-11-25',
    ...
    permissions: ['Send emails', 'Receive emails', 'Manage inbox'],
    feedbackEnabled: true,
    isNew: true,
    averageRating: 5.0,
    totalRatings: 1,
  ...
  calendar: {
    ...
    hasWidget: true,
    widgetSize: 'large',
    longDescription: 'Comprehensive calendar application for managing your schedule, events, and appointments. View community events, schedule meetings, set reminders, and stay organized.',
    tags: ['calendar', 'schedule', 'events', 'essential'],
    version: '1.0.0',
    developer: 'Montrecott Team',
    releaseDate: '2025-11-25',
    lastUpdated: '2025-11-25',
    ...
    permissions: ['View calendar', 'Create events', 'Manage schedule'],
    feedbackEnabled: true,
    isNew: true,
    averageRating: 5.0,
    totalRatings: 1,
  ...
  settings: {
    ...
    canPinToDock: true,
    hasWidget: false,
    longDescription: 'System configuration and preferences. Customize your experience, manage notifications, adjust accessibility settings, and configure system-wide options.',
    tags: ['settings', 'configuration', 'preferences', 'essential'],
    version: '1.0.0',
    developer: 'Montrecott Team',
    releaseDate: '2025-11-25',
    lastUpdated: '2025-11-25',
    ...
    permissions: ['Modify settings', 'Configure system'],
    feedbackEnabled: true,
    isNew: true,
    averageRating: 5.0,
    totalRatings: 1,
