...
const PRODUCTIVITY_APPS: ProductivityApp[] = [
  {
    ...
    longDescription: 'Professional email client with WebOS-style three-pane layout. Manage multiple accounts, organize folders, and handle attachments seamlessly.',
  ...
  },
  {
    ...
    longDescription: 'Visual app builder for creating WebOS-style applications. Choose templates, customize layouts, and export production-ready code.',
